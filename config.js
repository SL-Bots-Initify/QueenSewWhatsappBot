...
module.exports = {
    ...
    ABT: process.env.AUTO_BİO_ABOUT === undefined ? 'Lasindu Official Bot' : process.env.AUTO_BİO_ABOUT,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    TEXT: process.env.TEXTTEXTTEXT === undefined ? 'SEWS' : process.env.TEXTTEXTTEXT.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'Lasindu Official Bot\n\n Join The WhatsApp Group \nSew Queen Edited\n\n' : process.env.ALIVE_MESSAGE,
    ...
    CPK: process.env.CAPTION_NAME === undefined ? 'Lasindu Official Bot' : process.env.CAPTION_NAME,
